...
export type MethodType = { CALL: null } | { CompositeQuery: null } | { QUERY: null };
export type OwnerReply = { Approved: Result_3 } | { NotFound: null } | { Rejected: string };
...
export type Result_3 = { Ok: CallResult } | { Err: string };
